...
const Footer = () => {
    return ( 
        <div className="flex flex-row justify-around items-center w-full bg-secondary 
                        py-6 px-5 border-gray-100 border-2 background bg-white mt-auto">
            <div>
                <p className="text-xs font-bold text-gray-400">© 2025 Hummingbird, Inc. All rights</p>
            </div>
